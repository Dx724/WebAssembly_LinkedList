...
var STATIC_BASE = 1024, STACK_BASE = 5244672, STACKTOP = STACK_BASE, STACK_MAX = 1792, DYNAMIC_BASE = 5244672, DYNAMICTOP_PTR = 1632;
...
if (Module["wasmMemory"]) {
 ...
 wasmMemory.grow(4294967296 / WASM_PAGE_SIZE / 2);
}
...
function writeStackCookie() {
 ...
 HEAPU32[(STACK_MAX >> 2) + 1 >>> 0] = 34821223;
 HEAPU32[(STACK_MAX >> 2) + 2 >>> 0] = 2310721022;
 HEAP32[0 >>> 0] = 1668509029;
}

function checkStackCookie() {
 var cookie1 = HEAPU32[(STACK_MAX >> 2) + 1 >>> 0];
 var cookie2 = HEAPU32[(STACK_MAX >> 2) + 2 >>> 0];
